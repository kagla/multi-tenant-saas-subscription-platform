...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <p class="text-xs text-gray-400 mt-1">{{ $churnedCount }} churned (30d)</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-4 border-b border-gray-200"><h3 class="font-medium">Plan Breakdown</h3></div>
        <table class="min-w-full">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Plan</th>
                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Tenants</th>
                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Price/mo</th>
                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Revenue/mo</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="bg-gray-50 font-bold">
                    <td class="px-6 py-3 text-sm" colspan="3">Total MRR</td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('revenueChart'), {
        ...
        data: {
            ...
            datasets: [{ label: 'Revenue', data: Object.values(monthlyData), backgroundColor: 'rgba(16,185,129,0.5)', borderColor: 'rgb(16,185,129)', borderWidth: 1, borderRadius: 4 }]
        },
